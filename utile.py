...
def is_legal_move(move, board_stat, NgBlackPsWhite):
    ...
    if move != () and is_valid_coord(move[0], move[1]) and board_stat[move[0]][move[1]] == 0:
...
def has_tile_to_flip(move, direction,board_stat,NgBlackPsWhite):
    ...
    ''' 
        ...
        Does:    Checks whether the player has any adversary's tile to flip
                 ...
                 About input: move is the (row, col) coordinates of where the 
    ...
    if is_valid_coord(move[0], move[1]):
        ...
        while True:
            ...
            elif board_stat[row][col] == NgBlackPsWhite:
                break
